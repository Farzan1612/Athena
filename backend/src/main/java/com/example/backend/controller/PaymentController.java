...
public class PaymentController {
    ...
    public ResponseEntity<String> testEndpoint() {
        ...
        return ResponseEntity.ok("Payment controller test endpoint working!");
    }

    // Create Razorpay order and return order details
    @GetMapping(value = "/razorpay/create-order",
    ...
    @GetMapping(value = "/razorpay/orders/{amount}",
            produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<?> createOrderWithPathVariable(@PathVariable double amount) {
        try {
            logger.info("Creating Razorpay order using path variable for amount: {}", amount);
